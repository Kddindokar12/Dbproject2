...
//echo "Success connecting to the db";
  ...
  $phone=$_POST['phone'];
  $desc=$_POST['desc'];
  $sql="INSERT INTO `trip`.`tripforme`(`name`,`age`,`gender`,`email`,`phone`,`desc`,`dt`)VALUES('$name','$age','$gender','$email','$phone','$desc',current_timestamp());";
...
<body>
    <img class="back" src="back.jpg" alt="GECA">
    <div class="container">
        <h3>Welcome to GECA Trip form</h3>
